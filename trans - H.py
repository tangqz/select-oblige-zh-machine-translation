...
# 处理文件夹中的所有JSON文件
input_folder = 'C:\\Users\\qizhi\\Desktop\\汉化\\窗社正式版\\script-jp-con2-sep-2'  # 替换为你的输入文件夹路径
output_folder = 'C:\\Users\\qizhi\\Desktop\\汉化\\窗社正式版\\script-cn-con2-sep-2'  # 替换为你的输出文件夹路径
